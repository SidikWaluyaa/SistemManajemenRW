<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Tambah Data Warga (Sesuai KTP)') }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('warga.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="nik" class="block mt-1 w-full" type="number" name="nik" :value="old('nik')" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                         ...
                         <div class="mb-6 border-b pb-2 mt-6">
                             <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Alamat Lengkap</h3>
                        </div>

                        <div class="mb-4">
                            <x-input-label for="alamat" :value="__('Alamat Jalan')" />
                            <textarea id="alamat" name="alamat" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" rows="2">{{ old('alamat') }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="rw" class="block mt-1 w-full" type="text" name="rw" :value="old('rw', '010')" />
                            </div>
                             <div>
                         ...
                         <!-- Section Lainnya -->
                         <div class="mb-6 border-b pb-2 mt-6">
                             <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Status & Lainnya</h3>
                        </div>
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="pekerjaan" class="block mt-1 w-full" type="text" name="pekerjaan" :value="old('pekerjaan', 'Pelajar/Mahasiswa')" />
                            </div>
                         </div>
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select id="status_hubungan_dalam_keluarga" name="status_hubungan_dalam_keluarga" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                    ...
                                    <option value="Pembantu" {{ old('status_hubungan_dalam_keluarga') == 'Pembantu' ? 'selected' : '' }}>Pembantu</option>
                                </select>
                            </div>
                            <div>
                                <x-input-label for="pendidikan" :value="__('Pendidikan Terakhir')" />
                                <x-text-input id="pendidikan" class="block mt-1 w-full" type="text" name="pendidikan" :value="old('pendidikan')" />
                            </div>
                         </div>
