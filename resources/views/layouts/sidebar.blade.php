    ...
    <nav class="flex-1 px-4 space-y-2 overflow-y-auto">
        ...
        @if(auth()->user()->isAdmin())
            <div class="pt-4 mt-4 border-t border-white/10" data-aos="fade-up" data-aos-delay="600">
                ...
                <a href="{{ route('users.index') }}" class="flex items-center px-4 py-3 text-white rounded-lg transition-all duration-200 {{ request()->routeIs('users.*') ? 'bg-red-500/30 shadow-lg' : 'hover:bg-red-500/20' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
