                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('bansos.program.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nama_program" class="block mt-1 w-full" type="text" name="nama_program" :value="old('nama_program')" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="jenis_bantuan" name="jenis_bantuan" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="Non-Tunai">Non-Tunai (Barang/Sembako)</option>
                            </select>
