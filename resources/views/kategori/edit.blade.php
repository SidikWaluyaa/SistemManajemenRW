                    ...
                    <form method="POST" action="{{ route('kategori.update', $category->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="jenis" name="jenis" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                <option value="Pemasukan" {{ old('jenis', $category->jenis) == 'Pemasukan' ? 'selected' : '' }}>Pemasukan</option>
                                <option value="Pengeluaran" {{ old('jenis', $category->jenis) == 'Pengeluaran' ? 'selected' : '' }}>Pengeluaran</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nominal_default" class="block mt-1 w-full" type="number" name="nominal_default" :value="old('nominal_default', $category->nominal_default)" placeholder="Contoh: 20000" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="deskripsi" name="deskripsi" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" rows="3">{{ old('deskripsi', $category->deskripsi) }}</textarea>
